...
# installed.
TCL_PREFIX='/home/sadiq/Thesis/ns-allinone-2.34'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/home/sadiq/Thesis/ns-allinone-2.34'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/home/sadiq/Thesis/ns-allinone-2.34/tcl8.4.18/unix -ltcl8.4${TCL_DBGX}'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/home/sadiq/Thesis/ns-allinone-2.34/lib -ltcl8.4${TCL_DBGX}'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/home/sadiq/Thesis/ns-allinone-2.34/include'
...
# compiled.
TCL_SRC_DIR='/home/sadiq/Thesis/ns-allinone-2.34/tcl8.4.18'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/home/sadiq/Thesis/ns-allinone-2.34/lib '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/home/sadiq/Thesis/ns-allinone-2.34/tcl8.4.18/unix -ltclstub8.4${TCL_DBGX}'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/home/sadiq/Thesis/ns-allinone-2.34/lib -ltclstub8.4${TCL_DBGX}'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/home/sadiq/Thesis/ns-allinone-2.34/tcl8.4.18/unix/libtclstub8.4${TCL_DBGX}.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/home/sadiq/Thesis/ns-allinone-2.34/lib/libtclstub8.4${TCL_DBGX}.a'
