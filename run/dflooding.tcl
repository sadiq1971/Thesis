...
#read current forwarding list from file current_output...

set fp [open "/home/sadiq/Thesis/run/current_output" r]
...
for {set i 0} {$i < 100 } { incr i} {
    ...
    file copy -force $current_output$i /home/sadiq/Thesis/run/output.txt
    set num [expr {$i % $num_nodes}]
    $ns at [expr $i / $b] "$a(99) send_message 200 3 {first message}  $MESSAGE_PORT"
