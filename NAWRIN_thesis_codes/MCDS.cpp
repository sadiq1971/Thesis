...
int ColorB[10000]={0},ColorG[10000]={0},ColorW[10000],ColorB_count=0,ColorG_count=0,ColorW_count=0;
int first_hop_nei[10000],first_count,cardi_check[1000],b;
double seconds;
...
int main()
{
    ...
    union_array[10000],intersection_array[10000],minus_array[10000];
        ...
        strcpy (r,"/home/sadiq/Thesis/NAWRIN_thesis_codes/outMCDS/");
        strcat(r,p);
        fp2=fopen(r,"w");
...

{
        ...
        int MaxWhite=-1,MinBlack=1000,Candidate[1000]={0},Temporary[1000]={0},BlackCount,WhiteCount;
        int Candidate_count=0,Temporary_count=0,dd[100],X[100],I[100],H[100];
        int neigh_max=0,Selected[100],Y[100],ycount=0,temp[100],g[100],Black1Count=0;
        ...
        ColorG_count= SetUnion(ColorG,Candidate,ColorG_count,Candidate_count);
        for(int i=0;i<ColorG_count;i++)
        {
            Candidate[i]=union_array[i];
            Candidate_count++;
        }
